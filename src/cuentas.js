// Echar cuentas: los números del apartado financiero.
//
// Separado de la pantalla (finanzas.js) porque es lo único de la app donde
// equivocarse no se nota.
//
// Una lista mal ordenada salta a la vista; un promedio mal calculado se cree.
//
